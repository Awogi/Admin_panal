...
import 'diploma_questions.dart';
import '../admin/Bachelor.dart';
import 'add_question.dart';
import 'mcq_settings.dart';
...
class _PharmacyDashboardState extends State<PharmacyDashboard> {
  ...
  bool isManageQuestionsExpanded = true;
              ...
              if (isWideScreen)
                Container(
                  ...
                  child: PharmacyMCQSidebar(
                    ...
                    isManageQuestionsExpanded: isManageQuestionsExpanded,
                    onManageQuestionsToggle: () => setState(() => isManageQuestionsExpanded = !isManageQuestionsExpanded),
                  ),
                ),
              Expanded(
                child: Column(
...
class PharmacyMCQSidebar extends StatelessWidget {
  ...
  final bool isManageQuestionsExpanded;
  final VoidCallback onManageQuestionsToggle;

  const PharmacyMCQSidebar({
    super.key,
    required this.selectedPage,
    required this.onPageSelected,
    required this.isManageQuestionsExpanded,
    required this.onManageQuestionsToggle,
  });
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildExpandableMenuItem(
                  Icons.quiz,
                  "Manage Questions",
                  isManageQuestionsExpanded,
                  onManageQuestionsToggle,
                ),
                if (isManageQuestionsExpanded) ...[
                  _buildSubMenuItem(Icons.school, "Diploma", "Diploma"),
                  _buildSubMenuItem(Icons.person, "Bachelors", "Bachelors"),
                ],
                SizedBox(height: 8),
  ...
  Widget _buildExpandableMenuItem(IconData icon, String title, bool isExpanded, VoidCallback onToggle) {
    return Container(
      margin: EdgeInsets.symmetric(vertical: 2),
      decoration: BoxDecoration(
  ...
  Widget _buildSubMenuItem(IconData icon, String title, String page) {
    ...
    return Container(
      margin: EdgeInsets.only(left: 16, top: 2, bottom: 2, right: 2),
      decoration: BoxDecoration(
        color: isSelected ? Color(0xFF14B8A6).withOpacity(0.1) : Colors.transparent,
        borderRadius: BorderRadius.circular(8),
      ),
